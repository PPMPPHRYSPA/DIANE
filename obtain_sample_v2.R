...
MS = read_csv("UPMC/MS/data_table/data_processed/UPMC_MS_2011_to_2021_Codified_monthly_counts_2023-05-23.csv")
MS = MS[grep(":",MS$code),]
AD = read_csv("UPMC/AD/data_table/data_processed/UPMC_AD_2011_to_2021_Codified_NLP_monthly_counts_2023-05-15.csv")
AD = AD[grep(":",AD$code),]
